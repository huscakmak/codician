        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">
                            Company Customer Edit
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ url('company-customer/list') }}">Company Customer
                                    List</a></li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('company-customer/edit/'.$detail->id) }}" method="POST"
                                      id="submitForm">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="first_name"
                                               value="{{ (old('first_name') ? old('first_name') : $detail->first_name) }}">
                                    </div>

                                    <div class="form-group">
                                        <label>Last Name:</label>
                                        <input type="text" class="form-control" name="last_name"
                                               value="{{ (old('last_name') ? old('last_name') : $detail->last_name) }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="email_address"
                                               value="{{ (old('email_address') ? old('email_address') : $detail->email_address) }}">
                                    </div>

                                    <div class="form-group">
                                        <label>Phone Number:</label>
                                        <input type="text" class="form-control" name="phone_number_mask"
                                               value="{{ (old('phone_number') ? old('phone_number') : $detail->phone_number) }}"
...
@section('jsAssets')
    ...
    <script>
        $(function () {
            ...
            @else
            $("select[name='title']").val("{{ $detail->title }}").trigger('change');
            @endif
